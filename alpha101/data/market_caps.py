...
def fetch_market_caps_from_coinpaprika(
...
def get_pair_market_caps(pairs, provider: str = "coinpaprika", http_proxy: str = None, https_proxy: str = None) -> pd.DataFrame:
    ...
    try:
        ...
        market_data_map = fetch_market_caps_from_coinpaprika(bases, http_proxy=http_proxy, https_proxy=https_proxy)
...
fetch_market_data_from_coinpaprika = fetch_market_caps_from_coinpaprika

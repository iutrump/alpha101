...
from alpha101.factors.operator_lib.polars import cross_section, regression, time_series, transforms
...
if missing_specs:
    raise RuntimeError(f"Polars operator specs reference missing functions: {missing_specs}")
